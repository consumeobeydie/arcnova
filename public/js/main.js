...
function showWalletOptions() {
  ...
  modal.style.cssText = 'position:fixed;top:70px;right:24px;background:#0d0d24;border:1px solid #1a1a3a;border-radius:12px;padding:8px;z-index:99999;min-width:200px;box-shadow:0 8px 32px rgba(0,0,0,0.4);';
  const address = localStorage.getItem('walletAddress');
